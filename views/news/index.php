                    ...
                    <?php foreach ($newsList as $news): ?>
                        <li>
                            ...
                            <div class="news__content">
                                <div class="new__pic">
                                    <a href="/news/<?=$news['category_slug']?>/<?=$news['id'].'-'.$news['slug'] ?>"><img src="<?=$news['path'] . $news['img']?>" width="180px" alt="iska"></a>
                                </div>
                                <div class="news__title">
                                    <a href="/news/<?=$news['category_slug']?>/<?=$news['id'].'-'.$news['slug'] ?>"><?=$news['title']?></a>
                                </div>
