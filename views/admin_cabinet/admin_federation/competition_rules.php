            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Федерація -> Правила змагань</h3>
                        <a href="" data-toggle="modal" data-target=".modal_create_position" class="btn btn-primary pull-right"><small class="glyphicon glyphicon-plus"></small>&nbsp; Добавить правило</a>
                    </div>
                    <div class="box-body">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-modal clearfix">
                    <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="title_position" class="col-sm-12 control-label">Название</label>
                            <div class="col-sm-12">
