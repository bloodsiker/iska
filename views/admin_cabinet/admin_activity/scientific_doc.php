            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Діяльність -> Наукова -> Документы</h3>
                        <a href="" data-toggle="modal" data-target=".modal_create_position" class="btn btn-primary pull-right"><small class="glyphicon glyphicon-plus"></small>&nbsp; Добавить документ</a>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                            ...
                            <?php if (is_array($listDoc)): ?>
                                <?php foreach ($listDoc as $doc): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/admin/federation/position/delete/<?=$doc['id']; ?>" onclick="return confirm('Вы уверены что хотите удалить?') ? true : false;" data-toggle="tooltip"
                ...
                <div class="container-modal clearfix">
                    <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="title" class="col-sm-3 control-label">Название документа</label>
                            <div class="col-sm-9">
                                <input type="text" name="title" class="form-control" id="title">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="addimg" class="col-sm-3 control-label">Файл</label>
                            <div class="col-sm-9">
                                <input type="file" name="file" id="addimg">
                            </div>
                        </div>
                        <div class="form-group button-group">
                            <input type="submit" name="add_document" value="Сохранить" class="btn btn-primary pull-right">
