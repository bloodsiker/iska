            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Редактировать фото-альбом => <?=$album['title']?></h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <select name="archive" class="form-control" id="archive">
                                        <option <?php if ($album['archive'] == '0') echo ' selected="selected"'; ?> value="0">В видео галерею</option>
                                        <option <?php if ($album['archive'] == '1') echo ' selected="selected"'; ?> value="1">В архив</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" name="sort" class="form-control" id="sort"
                                           value="<?php echo $album['sort'] ?>">
                                </div>
                            </div>

                            <div class="form-group">
                                <div class="col-sm-9 col-md-offset-2">
                                    <img src="<?php echo $album['path'] . $album['img']?>" width="200" alt="">
                                </div>
                            </div>
